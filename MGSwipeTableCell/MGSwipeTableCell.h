...
/** Buttons State */
typedef NS_ENUM(NSInteger, MGSwipeButtonDirection) {
    MGSwipeButtonDirectionHorizontal = 0,
    MGSwipeButtonDirectionVertical,
};
...
@property (nonatomic, strong, nonnull) UIView * swipeOverlay;
@property (nonatomic) MGSwipeButtonDirection  swipeButtonDirection;
